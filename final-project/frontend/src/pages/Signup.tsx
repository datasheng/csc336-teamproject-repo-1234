  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await apiSignup({
        ...
        organizationDescription: createOrganization ? organizationDescription : undefined,
      });
            ...
            <div className="border-t border-stone-200 pt-4 mt-4">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-5 h-5 text-orange-600 border-2 border-stone-300 rounded focus:ring-orange-500"
                />
                <span className="text-sm font-medium text-stone-700">
                  I want to create an organization to host events
                </span>
              </label>
              
              {createOrganization && (
                <div className="mt-4 space-y-4 pl-8 border-l-2 border-orange-200">
                  <div>
                    <label htmlFor="organizationName" className="block text-sm font-medium text-stone-700 mb-1">
                  ...
                  <div>
                    <label htmlFor="organizationDescription" className="block text-sm font-medium text-stone-700 mb-1">
